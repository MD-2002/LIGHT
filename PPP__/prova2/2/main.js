...
function animate() {
    ...
    //matrix=matrixMultiplication(matrix, rotateY(out));
    //matrix=matrixMultiplication(matrix, rotateZ(out));
    matrix=matrixMultiplication(identityMat4(), scaleMatrix);
