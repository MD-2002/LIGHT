...
function animate() {
    ...
    const perspectiveMatrix = perspectiveTransformation(p);
    const pppmatrix= perspective(fov,aspect,near, far);

    matrix=matrixMultiplication(identityMat4(),rotateX(out));
    matrix = matrixMultiplication(matrix, rotateY(out2));
    matrix = matrixMultiplication(matrix,rotateZ(out3));
    matrix = matrixMultiplication(matrix, scaleMatrix);
    matrix = matrixMultiplication(matrix, translationMatrix);
    matrix = matrixMultiplication(perspectiveMatrix,matrix);
    matrix= matrixMultiplication(matrix, pppmatrix);
