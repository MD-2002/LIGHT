...
let matrixB= Math.PI/4; // moved and changed angleinradians to here
let out= 0;
let out2= 0;
let out3= 0;
let x=0;
...
const scaleMatrix = scale(0.6, 0.6, 0);
const translationMatrix = translate(x, y, 0);
...
function animate() {
    ...
    document.onkeydown = function (event) {
        switch (event.key) {
            case "a":      //rotate clockwise along the y-axis
                out3 += Math.PI/20;
                break;
            case "c":       //rotate unticlockwise along the y-axis
                out3 -= Math.PI/20;
                break;
            case "r":       //rotate unticlockwise along the y-axis
                x +=0.09;
                break;
            case "l":       //rotate unticlockwise along the y-axis
                x -=0.09;
                break;
            case "u":       //rotate unticlockwise along the y-axis
                y +=0.09;
                break;
            case "d":       //rotate unticlockwise along the y-axis
                y -=0.09;
                break;
   ...
   when using this function don't forget to comment const translationMatrix = translate(x, y, 0); outside of the loop*/
