...
function animate() {
    ...
    document.onkeydown = function (event) {
        switch (event.key) {
            ...
            case "ArrowLeft":
                ...
                break;
            case "D":
                // Define the distance to the far plane for the perspective transformation
                far += 1;
                break;
            case "C":
    ...
    const perspectiv=perspective(matrixA, fov,  aspect, near,  far );
    ...
    //finalMatrix = matrixMultiplication(finalMatrix, perspectiveMatrix);
    const pv= matrixMultiplication(finalMatrix, perspectiv);
    gl.uniformMatrix4fv(matrixLocation, false, pv);
