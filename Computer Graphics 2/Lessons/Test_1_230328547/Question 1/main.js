...
gl.bindBuffer(gl.ARRAY_BUFFER, buffer2); // bind the buffer
...
gl.bindBuffer(gl.ARRAY_BUFFER, buffer3); // bind the buffer
...
gl.drawArrays(gl.LINE_LOOP, 0, vertexData2.length/2);

gl.useProgram(program3);
gl.drawArrays(gl.POINTS, 0, vertexData2.length/2);
