...
const scaleMatrix = scale(0.4, 0.4, 0);
const translationMatrix = translate(-0.70, 0, -1);

const scaleMatrix1 = scale(0.4, 0.4, 0);
const translationMatrix1= translate(0, 0, 0);

const scaleMatrix2 = scale(0.4, 0.4, 0);
const translationMatrix2= translate(0.70, 0, 0);
...
function animate() {
    ...
    document.onkeydown = function (event) {
        switch (event.key) {
            case "X": //Move first cube on the x axis clockwise
                out += Math.PI/20;
                break;
            case "x": //Move first cube on the x axis clockwise
                out += Math.PI/20;
                break;
            case "Y":  //Move first cube on the y axis clockwise
                out2 += Math.PI/20;
                break;
            case "y":  //Move first cube on the y axis clockwise
                out2 += Math.PI/20;
                break;
            case "z":      //Move first cube on the z axis clockwise
                out3 += Math.PI/20;
                break;
            case "Z":      //Move first cube on the z axis clockwise
                out3 += Math.PI/20;
                break;
            case "a":      //Move second cube on the x axis clockwise
                out4 += Math.PI/20;
                break;
            case "A":      //Move second cube on the x axis clockwise
                out4 += Math.PI/20;
                break;
            case "s":      //Move second cube on the y axis clockwise
                out5 += Math.PI/20;
                break;
            case "S":      //Move second cube on the y axis clockwise
                out5 += Math.PI/20;
                break;
            case "d":      //Move second cube on the z axis clockwise
                out6 += Math.PI/20;
                break;
            case "D":      //Move second cube on the z axis clockwise
                out6 += Math.PI/20;
                break;
            case "q":      //Move third cube on the x axis clockwise
                out7 += Math.PI/20;
                break;
            case "Q":      //Move third cube on the x axis clockwise
                out7 += Math.PI/20;
                break;
            case "w":      //Move third cube on the y axis clockwise
                out8 += Math.PI/20;
                break;
            case "W":      //Move third cube on the y axis clockwise
                out8 += Math.PI/20;
                break;
            case "e":      //Move third cube on the z axis clockwise
                out9 += Math.PI/20;
                break;
            case "E":      //Move third cube on the z axis clockwise
                out9 += Math.PI/20;
